...
/**
 * Title: Timeline
 * Slug: blue-raeven/timeline
 * Categories: blue-raeven-content
 * Description: Vertical timeline with gold dots
 */
?>
<!-- wp:html -->
<section class="section section--cream">
    <div class="container">
        <div class="section__header">
            <div class="section__label">Our Journey</div>
            <h2 class="section__title">A Flavorful History</h2>
            <p class="section__script">Growing together, season by season</p>
        ...
        <div class="timeline">
            ...
            <div class="timeline__item">
                ...
                <div class="timeline__images">
                    ...
                    <img src="/wp-content/uploads/2024/timeline/raevenbrook-field.jpg" alt="Farm field rows" loading="lazy">
                </div>
            </div>
            <div class="timeline__item">
            ...
            <div class="timeline__item">
                ...
                <div class="timeline__images">
                    ...
                    <img src="/wp-content/uploads/2024/timeline/kitchen-workers.jpg" alt="Commercial kitchen pie making" loading="lazy">
                </div>
            </div>
            <div class="timeline__item">
